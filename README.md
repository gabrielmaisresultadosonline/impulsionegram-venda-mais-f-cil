# Impulsionegram: Venda Mais Fácil

crie uma pagina nome é Impulsionegram

coloque nunca foi tao facil vender mais sem precisar de muito esforço, ganhe popularidade do seu negocio com seguidores filtrados po regiao e filtrados do seu concorrente. 


Planos basicos 
Plano 1000 seguidores brasileiros filtrados por região - R$14
2000 seguidores fitlrados por regiao + curtidas R$29
5000 seguidores fitlrados por regiao  + curtidas R$57



Plano marketin completo 
+ de 10 mil visualizações
+2000 Seguidores filtrados por regiao
+ Curtidas
+comentarios  por 30 DIAS 

R$147



esses vai ser os planos ele vai pode colocar 5 publicações do perfil seja foto ou reels e vai compartilhar o link do perfil salvar e pagar pagando ja recebe confirmacao ali mesmo no dashboard dele de acesso e aguarda até 6 horas para entrar o resultado no perfil. 

o pagamento vai ser via inifinitpay via pagamento link ali webhoojk de verificação de pagameneto aprovado ali em tmepo real 
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/5306062e-dd22-4505-a2c3-baf689a08983).
