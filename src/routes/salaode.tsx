...
export const Route = createFileRoute("/salaode")({
  head: () => ({
    meta: [
      {
        title: "POPULAR Salão de Beleza — Mais clientes, mais seguidores",
      },
      {
        name: "description",
        content:
      ...
      {
        property: "og:title",
        content: "POPULAR Salão de Beleza — Mais clientes, mais seguidores",
      },
      {
...
function SalonPage() {
  ...
  useEffect(() => {
    void trackSiteEvent({ data: { type: "pageview", source: "salaode" } });
  }, []);
  ...
  return (
    <main className="min-h-screen">
      <Hero
        ...
        headline={["Mais clientes,", "Mais seguidores", "no seu Salão de Beleza!"]}
      ...
      <section className="px-4 py-20" id="planos">
        <div className="mx-auto max-w-6xl">
          <h2 className="text-3xl font-extrabold text-balance md:text-4xl">
            Planos <span className="text-gradient-brand">para salão de beleza</span>
          </h2>
          <p className="mt-3 max-w-2xl text-muted-foreground">
            Escolha o ideal para o seu salão. Entrega em até 6 horas após a confirmação do pagamento.
          </p>
      ...
      <section className="px-4 pb-24">
        <div className="glass-panel mx-auto max-w-3xl rounded-3xl p-8 text-center md:p-12">
          <h2 className="text-2xl font-extrabold text-balance md:text-3xl">
            Pronto para <span className="text-gradient-brand">ficar lotada de clientes?</span>
          </h2>
      ...
      <SignupDialog open={signupOpen} onOpenChange={setSignupOpen} redirectTo="/painel?source=salaode" source="salaode" />
